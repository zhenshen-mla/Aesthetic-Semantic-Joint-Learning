...
def read_data():
    c1 = np.load('/home1/herundong1/Downloads/liuxiangfei/Aes_Seg/data_process/list_index0.npy')
    c2 = np.load('/home1/herundong1/Downloads/liuxiangfei/Aes_Seg/data_process/list_aes0.npy')
    c3 = np.load('/home1/herundong1/Downloads/liuxiangfei/Aes_Seg/data_process/list_seg0.npy')

    # for delta=1, the val set must delta=0
    # c4 = np.load('/home1/shenzhen/PycharmProjects/untitled/voc_deeplab/me/final/Aes_Seg/data_process/list_index0.npy')
    # c5 = np.load('/home1/shenzhen/PycharmProjects/untitled/voc_deeplab/me/final/Aes_Seg/data_process/list_aes0.npy')
    # c6 = np.load('/home1/shenzhen/PycharmProjects/untitled/voc_deeplab/me/final/Aes_Seg/data_process/list_seg0.npy')
    ...
    #     if count > 3000:
    #         break
    #     if c4[i] not in train_path_decode:
    #         # print(i, count)
    #         count += 1
    #         val_path_decode.append(c4[i])
    #         val_label_aes.append(c5[i])
    #         val_label_seg.append(c6[i])

    random.seed(702)
    random.shuffle(train_path_decode)
    random.seed(702)
    random.shuffle(train_label_aes)
    random.seed(702)
    random.shuffle(train_label_seg)
    random.seed(702)
    random.shuffle(val_path_decode)
    random.seed(702)
    random.shuffle(val_label_aes)
    random.seed(702)
    random.shuffle(val_label_seg)
...
class MyDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        image = Image.open('/home/liuxiangfei/images/' + self.path[index]+'.jpg').convert('RGB')
